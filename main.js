...
var categoriesCollection = document.querySelectorAll('.category');
var closingOpeningSidebarButton = document.querySelector('.closing-opening-sidebar-button');
var mainContent = document.querySelector('.main-content');
var header = document.querySelector('.header');
var text = header.querySelector('.text');
var couponsContainer = document.querySelector('.coupons-container');
var couponsCollection = document.querySelectorAll('.coupon');
var isClosedSidebar = true;
...
function changeClassListCategory() {
  ...
  var thisHeading = this.querySelector('.heading');
  categoriesCollection.forEach(function (element) {
...
function changeClassListCoupon() {
  var thisElement = this;
  couponsCollection.forEach(function (element) {
    if (element.id === thisElement.id) {
      element.classList.remove('default');
      element.classList.add('active');
    } else {
